...
I work on [Super.Events](https://super.events) - Live Q&A platform.

In the past, I worked on [Facebook Marketplace Growth Team](/growth-handbook/).

Before Meta, I worked for Microsoft where I helped to build the [new Azure Management Portal](/azure-portal-the-largest-single-page-app-in-the-world/), [Azure Management Mobile App](https://azure.microsoft.com/en-us/get-started/azure-portal/mobile-app/), [Azure Search Management UI](https://azure.microsoft.com/en-us/products/search/), and [SeeingAI app](/seeing-ai-photo-gallery/).
...
I occasionally speak at conferences around the World. You can find my talks in the <a href="http://jj09.net/speaking/">speaking section</a> and on <a href="https://www.youtube.com/@jj09">my youtube channel</a>.</p>
