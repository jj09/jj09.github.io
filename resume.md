...
<ul>
  <li>Meta: Software Engineer (9/2019 - Present)
    <ul>
      <li>AI glasses - building <a href="https://www.meta.com/superintelligence/">personal superintelligence</a> for the next-gen <a href="https://www.meta.com/ai-glasses/">AI glasses</a> (Python, GraphQL, Hack/PHP, iOS/Swift, Android/Kotlin).</li>
      <li>Meta Superintelligence Labs (fka GenAI) - built <a href="https://ai.meta.com/ai-studio">GenAI Agents platform</a> (React, GraphQL, Hack/PHP): led multiple initiatives including building an experimentation platform for product and LLM models across multiple apps, running first A/B tests to find PMF, enabling external knowledge for AI Agents with <a href="https://research.facebook.com/file/4283170945104179/Retrieval-Augmented-Generation-for-Knowledge-Intensive-NLP-Tasks.pdf">RAG</a>, orchestrating <a href="https://about.fb.com/news/2024/07/create-your-own-custom-ai-with-ai-studio">AI Studio launch</a> across 100+ people and 3 apps (Facebook, Instagram, WhatsApp), personalization and LLM capabilities.</li>
      <li><a href="https://www.theverge.com/2019/7/9/20687760/facebook-experimental-apps-npe-team-label-launch-ios-android-web">New Products Experimentation</a> - worked on new products at Meta (<a href="https://techcrunch.com/2022/08/05/meta-testing-livestreaming-platform-influencers-super">Super</a> and one undisclosed app): I was responsible for technical leadership, Full-Stack web + mobile development, and AWS infra (Vue.js, node.js, MongoDB, AWS, iOS, Swift).</li>
  ...
  <li>Microsoft: Software Engineer (9/2014 - 9/2019)
    <ul>
      <li>Azure Search - I led redesign and rebuilt of Azure Search Management Console to improve performance, usability and reliability. I also integrated UI generation tool to simplify service adoption, and did early growth work (TypeScript, C#, Knockout.js).</li>
      <li><a href="https://jj09.net/under-the-hood-of-the-azure-mobile-app/">Microsoft Azure App</a> - mobile app enabling to manage and monitor Azure Cloud Services: I bootstrapped the app by designing the app architecture and writing the first lines of code. From a hackathon project it became an official Microsoft product in less than 6 months (Xamarin, iOS, Android, UWP, C#, xUnit, NUnit, <a href="https://www.xamarin.com/test-cloud">Xamarin Test Cloud</a>, <a href="https://www.visualstudio.com/team-services/">VSTS</a>).</li>
      <li><a
          href="https://channel9.msdn.com/events/Visual-Studio/Visual-Studio-Live-Redmond-2016/T15">Azure Management Portal</a> - first large-scale Web App written in TypeScript. As a member of the Core team, I was responsible for web components, and fixing complex performance issues that unblocked the launch of the product (<a
