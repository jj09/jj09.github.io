...
If you don't want to pay for OpenAI API, you can use one of the open-source Large Language Models locally. OpenAI models are not open source, but there are a lot of [open-source models that you can find on HuggingFace](https://huggingface.co/models). Iván Martínez created an awesome Github repo [privateGPT](https://github.com/imartinez/privateGPT). It uses [`sentence-transformers`](https://www.sbert.net/) python package to create embeddings with one of the [Open Source embedding models](https://huggingface.co/spaces/mteb/leaderboard), and [GPT4All](https://gpt4all.io/) - LLM wrapper to query your data with LangChain and LLM. [This Youtube video](https://www.youtube.com/watch?v=jxSPx1bfl2M) shows step-by-step how to do it.
